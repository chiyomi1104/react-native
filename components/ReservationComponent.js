      ...
      [
        {
          text: "Cancel",
          onPress: () => {
            console.log("Reservation Search Pressed");
            this.resetForm();
          },
          style: "cancel",
        },
        ...
        <Animatable.View animation="zoomIn" duration={2000} delay={1000}>
          ...
          <View style={styles.formRow}>
            ...
            <Switch
              ...
              trackColor={{ true: "#56370D", false: null }}
          ...
          {/* <Modal
                    ...
                    <View styles={styles.modal}>
                        <Text style={styles.modalTitle}>Search Campsite Reservatinos</Text>
                        <Text style={styles.modalTitle}>Number of Campers</Text>
                        <Text style={styles.modalTitle}>Hike In?: {this.state.hikeIn ? 'Yes' : 'No'}</Text>
                        <Text style={styles.modalTitle}>Date: {this.state.date.toLocaleDateString('en-US')}</Text>
